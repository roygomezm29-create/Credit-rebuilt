window.onerror = function(msg, url, line, col, error) {
  ...
  div.style.cssText = 'position:fixed;bottom:0;left:0;right:0;background:red;color:white;padding:10px;font-size:12px;z-index:99999;max-height:200px;overflow:auto;';
