  ...
  app.innerHTML = `
    ...
    <div class="modal-overlay" id="settings-overlay">
      <div class="modal-sheet">
        ...
        <button id="settings-notifications-btn" class="btn btn-block" style="margin-top:10px;">Activar notificaciones</button>
...
function attachHandlers() {
  ...
  const settingsNotificationsBtn = document.getElementById("settings-notifications-btn");
  if (settingsNotificationsBtn) settingsNotificationsBtn.addEventListener("click", () => activarNotificaciones());
...
/* ---------------------------- NOTIFICACIONES PUSH ---------------------------- */
const VAPID_PUBLIC_KEY = 'BGN5nbrVpX28_66c7jw5gdd3oHEWNMVXwe357kUYyAaLen5RDNWmsN0diNls8yGFQvTBT58YdHUAHfn1e1y2N6s';
