const CACHE_NAME = "capacidad-cache-v5";
...
// CACHE_NAME de esta línea (ej. "capacidad-cache-v6"). Si no lo haces, los
...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification(data.title || 'Credit', {
      body: data.body || '',
